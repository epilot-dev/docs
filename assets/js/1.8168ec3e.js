...
/* harmony import */ var _chunk_QXUST7PY_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(28659);
/* harmony import */ var _chunk_HN2XXSSU_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(84593);
/* harmony import */ var _chunk_JZLCHNYA_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(31792);
/* harmony import */ var _chunk_CVBHYZKI_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5016);
/* harmony import */ var _chunk_ATLVNIR6_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(2831);
/* harmony import */ var _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(48769);
/* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(4284);
/* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(99970);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(35096);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(1251);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(59792);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(51117);
...
var ErDB = class {
  ...
  addEntity(name, alias = "") {
    if (!this.entities.has(name)) {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log.info */ .cM.info("Added new entity :", name);
    } else if (!this.entities.get(name)?.alias && alias) {
      this.entities.get(name).alias = alias;
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log.info */ .cM.info(`Add alias '${alias}' to entity '${name}'`);
    }
  ...
  addAttributes(entityName, attribs) {
    ...
    for (i = attribs.length - 1; i >= 0; i--) {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log.debug */ .cM.debug("Added attribute ", attribs[i].name);
    }
  }
  /**
   * Add a relationship
  ...
  addRelationship(entA, rolA, entB, rSpec) {
    ...
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log.debug */ .cM.debug("Added new relationship :", rel);
  }
  getRelationships() {
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .eW)(async function(text, id, _version, diag) {
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log.info */ .cM.info("REF0:");
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log.info */ .cM.info("Drawing er diagram (unified)", id);
  ...
  const padding = 8;
  _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_9__/* .utils_default.insertTitle */ .w8.insertTitle(
    svg,
    "erDiagramTitleText",
