...
/* harmony import */ var _chunk_55IACEB6_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(26620);
/* harmony import */ var _chunk_QN33PNHL_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(43663);
/* harmony import */ var _chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(23386);
/* harmony import */ var _chunk_QXUST7PY_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(28659);
/* harmony import */ var _chunk_HN2XXSSU_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(84593);
/* harmony import */ var _chunk_JZLCHNYA_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(31792);
/* harmony import */ var _chunk_CVBHYZKI_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(5016);
/* harmony import */ var _chunk_ATLVNIR6_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(2831);
/* harmony import */ var _chunk_JA3XYJ7Z_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(48769);
/* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(4284);
/* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(99970);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(35096);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(1251);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(59792);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(51117);
...
var FlowDB = class {
  ...
  sanitizeText(txt) {
    return _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .common_default.sanitizeText */ .SY.sanitizeText(txt, this.config);
  }
  /**
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log.info */ .cM.info("abc78 Got edge...", edge);
    ...
    if (this.edges.length < (this.config.maxEdges ?? 500)) {
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log.info */ .cM.info("Pushing edge...");
...
You have to call mermaid.initialize.`
  ...
  addLink(_start, _end, linkData) {
    ...
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log.info */ .cM.info("addLink", _start, _end, id);
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__/* .utils_default.runFunc */ .w8.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach((id) => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__/* .utils_default.formatUrl */ .w8.formatUrl(linkStr, this.config);
  ...
  addSubGraph(_id, list, _title) {
    ...
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log.info */ .cM.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
  ...
  defaultConfig() {
    return _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_12__/* .defaultConfig2.flowchart */ .Fy.flowchart;
  }
};
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(async function(text, id, _version, diag) {
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log.info */ .cM.info("REF0:");
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log.info */ .cM.info("Drawing state diagram (v2)", id);
  ...
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log.debug */ .cM.debug("Before getData: ");
  const data4Layout = diag.db.getData();
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log.debug */ .cM.debug("Data: ", data4Layout);
  ...
  if (data4Layout.layoutAlgorithm === "dagre" && layout === "elk") {
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log.warn */ .cM.warn(
  ...
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .log.debug */ .cM.debug("REF1:", data4Layout);
  await (0,_chunk_N4CR4FBY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .render */ .sY)(data4Layout, svg);
  const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
  _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_11__/* .utils_default.insertTitle */ .w8.insertTitle(
    svg,
    "flowchartTitleText",
...
var parser = (function() {
  ...
  var lexer = /* @__PURE__ */ (function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(function() {
        this._more = true;
        return this;
      }, "more"),
      ...
      next: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_13__/* .__name */ .eW)(function topState(n) {
