...
/* harmony export */ });
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(35096);
...
/* harmony export */ });
/* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99970);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35096);
...
/* harmony export */ });
/* harmony import */ var _chunk_TZMSLE5B_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29270);
/* harmony import */ var _chunk_MI3HLSF2_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(57923);
/* harmony import */ var _chunk_QZHKN3VN_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6095);
/* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4284);
/* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99970);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(35096);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1251);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17967);
...
var SequenceDB = class {
  ...
  parseMessage(str) {
    ...
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.debug */ .cM.debug(`parseMessage: ${JSON.stringify(message)}`);
    return message;
  }
  ...
  addLinks(actorId, text) {
    ...
    try {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.error */ .cM.error("error while parsing actor link text", e);
    }
  }
  ...
  addProperties(actorId, text) {
    ...
    try {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.error */ .cM.error("error while parsing actor properties text", e);
    }
  }
  ...
  addDetails(actorId, text) {
    ...
    try {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.error */ .cM.error("error while parsing actor details text", e);
    }
  }
...
var drawText = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(elem, textData) {
  ...
  let textHeight = 0;
  const lines = textData.text.split(_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.lineBreakRegex */ .SY.lineBreakRegex);
...
var _drawTextCandidateFunc = /* @__PURE__ */ (function() {
  ...
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    ...
    const lines = content.split(_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.lineBreakRegex */ .SY.lineBreakRegex);
...
var bounds = {
  ...
  insert: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(startx, starty, stopx, stopy) {
    const _startx = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMin */ .SY.getMin(startx, stopx);
    const _stopx = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(startx, stopx);
    const _starty = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMin */ .SY.getMin(starty, stopy);
    const _stopy = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(starty, stopy);
  ...
  bumpVerticalPos: /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(bump) {
    ...
    this.data.stopy = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(this.data.stopy, this.verticalPos);
  }, "bumpVerticalPos"),
...
async function boundMessage(_diagram, msgModel) {
  ...
  const lines = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.splitBreaks */ .SY.splitBreaks(message).length;
  const isKatexMsg = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .l0)(message);
  const textDims = isKatexMsg ? await (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .nH)(message, (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()) : _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.calculateTextDimensions */ .w8.calculateTextDimensions(message, messageFont(conf));
  if (!isKatexMsg) {
  ...
  if (startx === stopx) {
    ...
    totalOffset += 30;
    const dx = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(textWidth / 2, conf.width / 2);
    bounds.insert(
      startx - dx,
...
var drawMessage = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(async function(diagram2, msgModel, lineStartY, diagObj) {
  ...
  const textDims = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.calculateTextDimensions */ .w8.calculateTextDimensions(message, messageFont(conf));
  const textObj = (0,_chunk_TZMSLE5B_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getTextObj */ .AD)();
  textObj.x = startx;
  textObj.y = starty + 10;
  ...
  if (startx === stopx) {
    if (conf.rightAngles) {
      line = diagram2.append("path").attr(
        "d",
        `M  ${startx},${lineStartY} H ${startx + _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`
      );
    } else {
      line = diagram2.append("path").attr(
        "d",
...
var addActorRenderingData = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  ...
  for (const actorKey of actorKeys) {
    ...
    actor.height = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(actor.height || conf.height, conf.height);
    actor.margin = actor.margin || conf.actorMargin;
    maxHeight = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(maxHeight, actor.height);
...
var drawActors = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(async function(diagram2, actors, actorKeys, isFooter) {
  if (!isFooter) {
    ...
    for (const actorKey of actorKeys) {
      ...
      maxHeight = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(maxHeight, height);
    }
...
var activationBounds = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(actor, actors) {
  ...
  const left = activations.reduce(
    function(acc, activation) {
      return _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMin */ .SY.getMin(acc, activation.startx);
    },
    actorObj.x + actorObj.width / 2 - 1
  );
  const right = activations.reduce(
    function(acc, activation) {
      return _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(acc, activation.stopx);
    },
    actorObj.x + actorObj.width / 2 + 1
  );
  return [left, right];
...
function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
  ...
  if (msg.id && msg.message && loopWidths[msg.id]) {
    ...
    msg.message = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.wrapLabel */ .w8.wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
    msg.width = loopWidth;
    msg.wrap = true;
    const textDims = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.calculateTextDimensions */ .w8.calculateTextDimensions(msg.message, textConf);
    const totalOffset = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(textDims.height, conf.labelBoxHeight);
    heightAdjust = postMargin + totalOffset;
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.debug */ .cM.debug(`${totalOffset} - ${msg.message}`);
  }
  addLoopFn(msg);
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(async function(_text, id, _version, diagObj) {
  ...
  bounds.init();
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.debug */ .cM.debug(diagObj.db);
    ...
    switch (msg.type) {
      ...
      default:
        try {
          ...
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.error */ .cM.error("error while drawing message", e);
        }
    }
    if ([
  ...
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.debug */ .cM.debug("createdActors", createdActors);
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.debug */ .cM.debug("destroyedActors", destroyedActors);
  ...
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.debug */ .cM.debug(`models:`, bounds.models);
}, "draw");
async function getMaxMessageWidthPerActor(actors, messages, diagObj) {
  ...
  for (const msg of messages) {
    if (actors.get(msg.to) && actors.get(msg.from)) {
      ...
      const wrappedMessage = msg.wrap ? _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.wrapLabel */ .w8.wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont) : msg.message;
      ...
      if (isMessage && msg.from === actor.nextActor) {
        maxMessageWidthPerActor[msg.to] = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(
          maxMessageWidthPerActor[msg.to] || 0,
          messageWidth
        );
      } else if (isMessage && msg.from === actor.prevActor) {
        maxMessageWidthPerActor[msg.from] = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(
        ...
        maxMessageWidthPerActor[actor.prevActor] = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(
  ...
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.debug */ .cM.debug("maxMessageWidthPerActor:", maxMessageWidthPerActor);
...
var getRequiredPopupWidth = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(actor) {
  ...
  for (const key in actor.links) {
    const labelDimensions = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.calculateTextDimensions */ .w8.calculateTextDimensions(key, textFont);
...
async function calculateActorMargins(actors, actorToMessageWidth, boxes) {
  ...
  for (const prop of actors.keys()) {
    ...
    if (actor.wrap) {
      actor.description = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.wrapLabel */ .w8.wrapLabel(
        actor.description,
    ...
    actor.width = actor.wrap ? conf.width : _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(conf.width, actDims.width + 2 * conf.wrapPadding);
    actor.height = actor.wrap ? _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(actDims.height, conf.height) : conf.height;
    maxHeight = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(maxHeight, actor.height);
  }
  for (const actorKey in actorToMessageWidth) {
    ...
    if (!nextActor) {
      ...
      actor.margin = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(actorWidth2, conf.actorMargin);
      continue;
    }
    const messageWidth = actorToMessageWidth[actorKey];
    const actorWidth = messageWidth + conf.actorMargin - actor.width / 2 - nextActor.width / 2;
    actor.margin = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(actorWidth, conf.actorMargin);
  }
  let maxBoxHeight = 0;
  boxes.forEach((box) => {
    ...
    if (box.wrap) {
      box.name = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.wrapLabel */ .w8.wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
    }
    const boxMsgDimensions = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.calculateTextDimensions */ .w8.calculateTextDimensions(box.name, textFont);
    maxBoxHeight = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(boxMsgDimensions.height, maxBoxHeight);
    const minWidth = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(totalWidth, boxMsgDimensions.width + 2 * conf.wrapPadding);
  ...
  return _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(maxHeight, conf.height);
}
...
var buildNoteModel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(async function(msg, actors, diagObj) {
  ...
  let textDimensions = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .l0)(msg.message) ? await (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .nH)(msg.message, (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()) : _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.calculateTextDimensions */ .w8.calculateTextDimensions(
    shouldWrap ? _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.wrapLabel */ .w8.wrapLabel(msg.message, conf.width, noteFont(conf)) : msg.message,
    noteFont(conf)
  );
  const noteModel = {
    width: shouldWrap ? conf.width : _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin),
    height: 0,
    startx: fromActor.x,
    stopx: 0,
    starty: 0,
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    noteModel.width = shouldWrap ? _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(conf.width, textDimensions.width) : _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(
      fromActor.width / 2 + toActor.width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx + (fromActor.width + conf.actorMargin) / 2;
  } else if (msg.placement === diagObj.db.PLACEMENT.LEFTOF) {
    noteModel.width = shouldWrap ? _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin) : _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(
      fromActor.width / 2 + toActor.width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx - noteModel.width + (fromActor.width - conf.actorMargin) / 2;
  } else if (msg.to === msg.from) {
    textDimensions = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.calculateTextDimensions */ .w8.calculateTextDimensions(
      shouldWrap ? _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.wrapLabel */ .w8.wrapLabel(msg.message, _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(conf.width, fromActor.width), noteFont(conf)) : msg.message,
      noteFont(conf)
    );
    noteModel.width = shouldWrap ? _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(conf.width, fromActor.width) : _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(fromActor.width, conf.width, textDimensions.width + 2 * conf.noteMargin);
  ...
  if (shouldWrap) {
    noteModel.message = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.wrapLabel */ .w8.wrapLabel(
      msg.message,
      noteModel.width - 2 * conf.wrapPadding,
      noteFont(conf)
    );
  }
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.debug */ .cM.debug(
...
var buildMessageModel = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(msg, actors, diagObj) {
  ...
  if (msg.wrap && msg.message) {
    msg.message = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.wrapLabel */ .w8.wrapLabel(
      msg.message,
      _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(boundedWidth + 2 * conf.wrapPadding, conf.width),
      messageFont(conf)
    );
  }
  const msgDims = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default.calculateTextDimensions */ .w8.calculateTextDimensions(msg.message, messageFont(conf));
  return {
    width: _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(
...
var calculateLoopBounds = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(async function(messages, actors, _maxWidthPerActor, diagObj) {
  ...
  for (const msg of messages) {
    ...
    if (isNote) {
      ...
      stack.forEach((stk) => {
        current = stk;
        current.from = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMin */ .SY.getMin(current.from, noteModel.startx);
        current.to = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(current.to, noteModel.startx + noteModel.width);
        current.width = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(current.width, Math.abs(current.from - current.to)) - conf.labelBoxWidth;
      });
    } else {
      ...
      if (msgModel.startx && msgModel.stopx && stack.length > 0) {
        stack.forEach((stk) => {
          ...
          if (msgModel.startx === msgModel.stopx) {
            ...
            current.from = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMin */ .SY.getMin(
              from.x - msgModel.width / 2,
              from.x - from.width / 2,
              current.from
            );
            current.to = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(
              to.x + msgModel.width / 2,
              to.x + from.width / 2,
              current.to
            );
            current.width = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(current.width, Math.abs(current.to - current.from)) - conf.labelBoxWidth;
          } else {
            current.from = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMin */ .SY.getMin(msgModel.startx, current.from);
            current.to = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(msgModel.stopx, current.to);
            current.width = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default.getMax */ .SY.getMax(current.width, msgModel.width) - conf.labelBoxWidth;
          }
        });
      }
    }
  ...
  bounds.activations = [];
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log.debug */ .cM.debug("Loop type widths:", loops);
  return loops;
}, "calculateLoopBounds");
