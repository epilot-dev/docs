...
var RequirementDB = class {
  ...
  addElement(name) {
    if (!this.elements.has(name)) {
      ...
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log.info */ .cM.info("Added new element: ", name);
    }
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .eW)(async function(text, id, _version, diag) {
  ...
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_11__/* .log.info */ .cM.info("Drawing requirement diagram (unified)", id);
