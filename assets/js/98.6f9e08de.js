...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1251);
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .eW)((txt) => _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default.sanitizeText */ .SY.sanitizeText(txt, (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)()), "sanitizeText");
var ClassDB = class {
  constructor() {
    this.relations = [];
  ...
  splitClassNameAndType(_id) {
    const id = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default.sanitizeText */ .SY.sanitizeText(_id, (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)());
    let genericType = "";
    let className = id;
    if (id.indexOf("~") > 0) {
  ...
  addClass(_id) {
    ...
    const name = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default.sanitizeText */ .SY.sanitizeText(className, (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)());
  ...
  addRelation(classRelation) {
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log.debug */ .cM.debug("Adding relation: " + JSON.stringify(classRelation));
    const invalidTypes = [
    ...
    classRelation.relationTitle1 = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default.sanitizeText */ .SY.sanitizeText(
      classRelation.relationTitle1.trim(),
      (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)()
    );
    classRelation.relationTitle2 = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default.sanitizeText */ .SY.sanitizeText(
  ...
  setLink(ids, linkStr, target) {
    ...
    ids.split(",").forEach((_id) => {
      ...
      if (theClass) {
        theClass.link = _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default.formatUrl */ .w8.formatUrl(linkStr, config);
  ...
  setClickFunc(_domId, functionName, functionArgs) {
    const domId = _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default.sanitizeText */ .SY.sanitizeText(_domId, (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)());
    const config = (0,_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)();
      ...
      this.functions.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default.runFunc */ .w8.runFunc(functionName, ...argList);
            },
            false
          );
        }
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .eW)(async function(text, id, _version, diag) {
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log.info */ .cM.info("REF0:");
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log.info */ .cM.info("Drawing class diagram (v3)", id);
  ...
  const padding = 8;
  _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default.insertTitle */ .w8.insertTitle(
    svg,
...
/* harmony export */ });
/* harmony import */ var _chunk_B4BG7PRW_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7329);
/* harmony import */ var _chunk_FMBD7UC4_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(61392);
