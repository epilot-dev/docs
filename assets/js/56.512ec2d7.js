...
/* harmony export */ });
/* harmony import */ var _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4284);
/* harmony import */ var _chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(99970);
/* harmony import */ var _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35096);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17967);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(27484);
/* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(59542);
/* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(10285);
/* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(28734);
/* harmony import */ var dayjs_plugin_duration_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1646);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(1251);
...
var getStartDate = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .eW)(function(prevTime, dateFormat2, str) {
  str = str.trim();
  const isTimestampFormat = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .eW)((format) => {
  ...
  if (mDate.isValid()) {
    ...
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log.debug */ .cM.debug("Invalid date:" + str);
    _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log.debug */ .cM.debug("With date format:" + dateFormat2.trim());
...
var setClickFun = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .eW)(function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _chunk_S3R3BYOJ_mjs__WEBPACK_IMPORTED_MODULE_0__/* .utils_default.runFunc */ .w8.runFunc(functionName, ...argList);
    });
  }
}, "setClickFun");
...
dayjs__WEBPACK_IMPORTED_MODULE_4__.extend(dayjs_plugin_duration_js__WEBPACK_IMPORTED_MODULE_8__);
var setConf = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .eW)(function() {
  _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log.debug */ .cM.debug("Something is calling, setConf, remove the call");
}, "setConf");
var mapWeekdayToTimeFunction = {
  monday: d3__WEBPACK_IMPORTED_MODULE_9__/* .timeMonday */ .Ox9,
  tuesday: d3__WEBPACK_IMPORTED_MODULE_9__/* .timeTuesday */ .YDX,
  wednesday: d3__WEBPACK_IMPORTED_MODULE_9__/* .timeWednesday */ .EFj,
  thursday: d3__WEBPACK_IMPORTED_MODULE_9__/* .timeThursday */ .Igq,
  friday: d3__WEBPACK_IMPORTED_MODULE_9__/* .timeFriday */ .y2j,
  saturday: d3__WEBPACK_IMPORTED_MODULE_9__/* .timeSaturday */ .LqH,
  sunday: d3__WEBPACK_IMPORTED_MODULE_9__/* .timeSunday */ .Zyz
};
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .eW)(function(text, id, version, diagObj) {
  ...
  if (securityLevel === "sandbox") {
    sandboxElement = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .select */ .Ys)("#i" + id);
  }
  const root = securityLevel === "sandbox" ? (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .select */ .Ys)(sandboxElement.nodes()[0].contentDocument.body) : (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .select */ .Ys)("body");
  ...
  const timeScale = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .scaleTime */ .Xf)().domain([
    (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .min */ .VV$)(taskArray, function(d) {
      return d.startTime;
    }),
    (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .max */ .Fp7)(taskArray, function(d) {
      return d.endTime;
    })
  ...
  function makeGantt(tasks2, pageWidth, pageHeight) {
    ...
    const colorScale = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .scaleLinear */ .BYU)().domain([0, categories.length]).range(["#00B9FA", "#F95002"]).interpolate(d3__WEBPACK_IMPORTED_MODULE_9__/* .interpolateHcl */ .JHv);
    drawExcludeDays(
      gap,
      topPadding,
      leftPadding,
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    if (securityLevel2 === "sandbox") {
      let sandboxElement2;
      sandboxElement2 = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .select */ .Ys)("#i" + id);
  ...
  function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
    ...
    if (dayjs__WEBPACK_IMPORTED_MODULE_4__(maxTime).diff(dayjs__WEBPACK_IMPORTED_MODULE_4__(minTime), "year") > 5) {
      _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log.warn */ .cM.warn(
  ...
  function getEstimatedTickCount(minTime, maxTime, every, interval) {
    ...
    const intervalMs = dayjs__WEBPACK_IMPORTED_MODULE_4__.duration({ [interval ?? "day"]: every }).asMilliseconds();
    if (intervalMs <= 0) {
      return Infinity;
    }
    return Math.ceil(timeDiffMs / intervalMs);
  }
  (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .eW)(getEstimatedTickCount, "getEstimatedTickCount");
  function makeGrid(theSidePad, theTopPad, w2, h2) {
    ...
    let bottomXAxis = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .axisBottom */ .LLu)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0,d3__WEBPACK_IMPORTED_MODULE_9__/* .timeFormat */ .i$Z)(axisFormat2));
    ...
    if (resultTickInterval !== null) {
      ...
      if (isNaN(every) || every <= 0) {
        ...
        if (estimatedTicks > MAX_TICK_COUNT) {
          ...
          switch (interval) {
            case "millisecond":
              bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeMillisecond.every */ .U8T.every(every));
              break;
            case "second":
              bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeSecond.every */ .S1K.every(every));
              break;
            case "minute":
              bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeMinute.every */ .Z_i.every(every));
              break;
            case "hour":
              bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeHour.every */ .WQD.every(every));
              break;
            case "day":
              bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeDay.every */ .rr1.every(every));
              break;
            case "week":
              bottomXAxis.ticks(mapWeekdayToTimeFunction[weekday2].every(every));
              break;
            case "month":
              bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeMonth.every */ .F0B.every(every));
              break;
          }
        }
      }
    ...
    if (diagObj.db.topAxisEnabled() || conf.topAxis) {
      let topXAxis = (0,d3__WEBPACK_IMPORTED_MODULE_9__/* .axisTop */ .F5q)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0,d3__WEBPACK_IMPORTED_MODULE_9__/* .timeFormat */ .i$Z)(axisFormat2));
      if (resultTickInterval !== null) {
        const every = parseInt(resultTickInterval[1], 10);
        if (isNaN(every) || every <= 0) {
          _chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log.warn */ .cM.warn(
          ...
          if (estimatedTicks <= MAX_TICK_COUNT) {
            switch (interval) {
              case "millisecond":
                topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeMillisecond.every */ .U8T.every(every));
                break;
              case "second":
                topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeSecond.every */ .S1K.every(every));
                break;
              case "minute":
                topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeMinute.every */ .Z_i.every(every));
                break;
              case "hour":
                topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeHour.every */ .WQD.every(every));
                break;
              case "day":
                topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeDay.every */ .rr1.every(every));
                break;
              case "week":
                topXAxis.ticks(mapWeekdayToTimeFunction[weekday2].every(every));
                break;
              case "month":
                topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_9__/* .timeMonth.every */ .F0B.every(every));
                break;
            }
          }
        }
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurrences).enter().append(function(d) {
      const rows = d[0].split(_chunk_ABZYJK2D_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default.lineBreakRegex */ .SY.lineBreakRegex);
