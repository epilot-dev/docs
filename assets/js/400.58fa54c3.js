...
;// CONCATENATED MODULE: ./node_modules/mermaid/node_modules/uuid/dist/esm/native.js

/* harmony default export */ const esm_native = ({ randomUUID: external_crypto_.randomUUID });

;// CONCATENATED MODULE: ./node_modules/mermaid/node_modules/uuid/dist/esm/rng.js
...
;// CONCATENATED MODULE: ./node_modules/mermaid/node_modules/uuid/dist/esm/stringify.js
...
;// CONCATENATED MODULE: ./node_modules/mermaid/node_modules/uuid/dist/esm/v4.js
...
var is_dark = __webpack_require__(91619);
...
var MindmapDB = class {
  ...
  addNode(level, id, descr, type) {
    chunk_AGHRB4JF/* log.info */.cM.info("addNode", level, id, descr, type);
    let isRoot = false;
    ...
    let padding = conf.mindmap?.padding ?? chunk_ABZYJK2D/* defaultConfig_default.mindmap.padding */.vZ.mindmap.padding;
    switch (type) {
    ...
    const node = {
      ...
      type,
      children: [],
      width: conf.mindmap?.maxNodeWidth ?? chunk_ABZYJK2D/* defaultConfig_default.mindmap.maxNodeWidth */.vZ.mindmap.maxNodeWidth,
      padding,
      isRoot
    };
  ...
  getType(startStr, endStr) {
    chunk_AGHRB4JF/* log.debug */.cM.debug("In get type", startStr, endStr);
    switch (startStr) {
      case "[":
  ...
  getData() {
    ...
    chunk_AGHRB4JF/* log.debug */.cM.debug("getData: mindmapRoot", mindmapRoot, config);
...
var draw = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.eW)(async (text, id, _version, diagObj) => {
  chunk_AGHRB4JF/* log.debug */.cM.debug("Rendering mindmap diagram\n" + text);
  const db = diagObj.db;
  ...
  (0,chunk_QN33PNHL/* setupViewPortForSVG */.j)(
    svg,
    data4Layout.config.mindmap?.padding ?? chunk_ABZYJK2D/* defaultConfig_default.mindmap.padding */.vZ.mindmap.padding,
    "mindmapDiagram",
    data4Layout.config.mindmap?.useMaxWidth ?? chunk_ABZYJK2D/* defaultConfig_default.mindmap.useMaxWidth */.vZ.mindmap.useMaxWidth
  );
}, "draw");
