...
var src = __webpack_require__(1251);
...
var findOrCreateNode = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.eW)((ID) => {
  ID = chunk_ABZYJK2D/* common_default.sanitizeText */.SY.sanitizeText(ID, (0,chunk_ABZYJK2D/* getConfig2 */.nV)());
...
var draw = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.eW)(function(text, id, _version, diagObj) {
  ...
  const defaultSankeyConfig = chunk_ABZYJK2D/* defaultConfig2.sankey */.Fy.sankey;
  let sandboxElement;
