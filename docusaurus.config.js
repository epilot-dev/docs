      ...
      [
        'redocusaurus',
        {
          ...
          specs: specs.map((spec) => ({
            ...spec,
            apiDocComponent: '../src/components/RedocPage',
          })),
          theme: {
            primaryColor: '#4C4CFF',
            redocOptions: {
        ...
        return {
          ...
          configureWebpack() {
            return {
              resolve: {
                alias: {
                  'mdx-mermaid/lib/Mermaid': path.resolve(
                    __dirname,
      ...
      [
        '@docusaurus/plugin-client-redirects',
        {
          ...
          createRedirects(existingPath) {
            ...
            if (
              existingPath.includes('/docs/integrations/integration-toolkit')
            ) {
              return [
...
This documentation covers all aspects of the epilot platform for developers, administrators, and integration partners.`,
      ...
      [
        require.resolve('./src/plugins/changelog/index.js'),
        {
          ...
          blogDescription:
            'Breaking changes, new features, and significant updates to epilot APIs.',
