...
[[API Docs](/api/pricing)] [[SDK](https://www.npmjs.com/package/@epilot/pricing-client)] | <a href="/pricing-playground/index.html" target="_blank" rel="noopener noreferrer">Pricing Demo Playground</a>
...
<a className="button button--secondary" href="/api/pricing">Pricing API Reference</a>
