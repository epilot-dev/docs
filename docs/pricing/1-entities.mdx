...
Three core entity types power epilot pricing. All are built on the [flexible entity](/docs/entities/flexible-entities) system -- extend them with custom attributes, attach workflows, and use [webhooks](/docs/webhooks/intro) to integrate pricing logic from external backends.
