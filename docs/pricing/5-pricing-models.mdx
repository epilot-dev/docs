...
The models can be unit based or flat-fee based as shown in the following image:

<div style={{ width: '100%', textAlign: 'center', padding: '20px 30px 20px 60px', border: '1px solid #dad2d2' }}>
  <img src="/img/pricing-models.jpg" alt="Pricing Models" />
</div>
<br />
...
<img style={{ width: '500px', borderRadius: '5px' }} src="/img/price-tiers-1.png" alt="Price Tiers" />
...
<img style={{ width: '500px', borderRadius: '5px' }} src="/img/price-tiers-2.png" alt="Price Tiers" />
