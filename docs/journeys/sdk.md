...
| `.contextData(value)`          | `ContextData`                 | -          | Additional key-value data passed to the Journey and included with the submission. Accepts `string` or `number` (coerced). See [Context Data](#context-data).                           |
